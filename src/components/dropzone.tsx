...
type DropzoneContextType = Omit<UseUploadReturn, 'getRootProps' | 'getInputProps'>
        ...
        return (
          ...
          >
            {file.type.startsWith('image/') ? (
              <div className="h-10 w-10 rounded border overflow-hidden shrink-0 bg-muted flex items-center justify-center" title="1:1 preview (server will crop to 1000×1000px)">
                <img
                  src={(file as any).squarePreview || file.preview}
                  alt={file.name}
...
const DropzoneEmptyState = ({ className }: { className?: string }) => {
  ...
  return (
    <div className={cn('flex flex-col items-center gap-y-2', className)}>
      ...
      >
        ✓ 1:1 Ratio · 1000×1000px auto-crop
      </span>
