        ...
        <div class="table-wrapper">
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php if (empty($items)): ?>
                        <tr>
                            <td colspan="6" class="py-12 text-center text-slate-400 italic">No customisation requests received yet.</td>
                        </tr>
                    <?php endif; ?>
                    <?php foreach ($items as $item): ?>
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td class="py-4 px-4 align-top">
                                <strong class="text-slate-900 font-semibold block"><?php echo htmlspecialchars($item['name']); ?></strong>
                                <span class="text-xs text-slate-500 block"><?php echo htmlspecialchars($item['email']); ?></span>
                                <span class="text-xs text-slate-500 block mt-0.5"><?php echo htmlspecialchars($item['contact_no']); ?></span>
                            </td>
                            <td class="py-4 px-4 align-top text-xs">
                                <span class="px-2.5 py-0.5 rounded bg-purple-50 text-purple-700 font-semibold border border-purple-200/60 inline-block">
