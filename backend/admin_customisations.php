...
<head>
    ...
    <title>Admin - Customisations Management</title>
    <style>
...
<div class="container">
    <div class="header-row">
        <h1>Admin Customisation Requests</h1>
        <div>
    ...
    <div class="nav-tabs">
        ...
        <a href="admin_customisations.php" class="active">Customisations</a>
    ...
    <table>
        ...
        <tbody>
            <?php if (empty($items)): ?>
                <tr><td colspan="5" style="text-align:center;">No customisation requests found.</td></tr>
            <?php
endif; ?>
            <?php foreach ($items as $item): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo htmlspecialchars($item['contact_no']); ?>
                    </td>
                    <td>
                        <strong>Type:</strong> <?php echo htmlspecialchars($item['event_type']); ?><br>
                        <strong>Service:</strong> <?php echo htmlspecialchars($item['service_name'] ?? 'N/A'); ?>
                    </td>
                    <td>
                        <div style="max-width:300px; white-space: pre-wrap;"><?php echo htmlspecialchars($item['message']); ?></div>
                    </td>
                    <td>
