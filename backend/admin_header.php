...
// Centralized Admin Logout Handling
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16 md:h-20">
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-xl gold-gradient flex items-center justify-center font-bold font-serif text-slate-950 text-xl shadow-lg">
                            OMG
                        </div>
                        <div>
                    ...
                    <nav class="hidden md:flex items-center space-x-1">
                        <a href="admin_orders.php"
                            class="<?php echo $currentPage === 'admin_orders.php' ? 'bg-slate-800 text-amber-400 font-semibold' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white'; ?> px-3 py-2 rounded-lg text-sm transition-all flex items-center gap-1.5">
                            <span>📦</span> Orders
                        </a>
                        <a href="admin_inquiries.php"
                            class="<?php echo $currentPage === 'admin_inquiries.php' ? 'bg-slate-800 text-amber-400 font-semibold' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white'; ?> px-3 py-2 rounded-lg text-sm transition-all flex items-center gap-1.5">Inquiries</a>
                        <a href="admin_customisations.php"
                            class="<?php echo $currentPage === 'admin_customisations.php' ? 'bg-slate-800 text-amber-400 font-semibold' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white'; ?> px-3 py-2 rounded-lg text-sm transition-all flex items-center gap-1.5">Customisations</a>
                        <a href="admin_surprises.php"
                            class="<?php echo $currentPage === 'admin_surprises.php' ? 'bg-slate-800 text-amber-400 font-semibold' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white'; ?> px-3 py-2 rounded-lg text-sm transition-all flex items-center gap-1.5">Surprises</a>
                        <a href="admin_products.php"
                            class="<?php echo $currentPage === 'admin_products.php' ? 'bg-slate-800 text-amber-400 font-semibold' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white'; ?> px-3 py-2 rounded-lg text-sm transition-all flex items-center gap-1.5">Products</a>
                        <?php if ($isMainAdmin): ?>
                            <a href="admin_manage.php"
                                class="<?php echo $currentPage === 'admin_manage.php' ? 'bg-slate-800 text-amber-400 font-semibold' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white'; ?> px-3 py-2 rounded-lg text-sm transition-all flex items-center gap-1.5">
                                <span>🛡️</span> Admins
                            </a>
                        <?php endif; ?>
                    </nav>
                    ...
                    <div class="hidden sm:flex items-center gap-4">
                        ...
                        <a href="admin_orders.php?logout=true"
