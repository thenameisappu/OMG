...
<div class="space-y-8">
    ...
    <div class="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col sm:flex-row justify-between items-center gap-4">
        <form method="GET" class="flex flex-wrap items-center gap-3 w-full sm:w-auto">
            <input type="text" name="search" placeholder="Search by name, SKU..." value="<?php echo htmlspecialchars($search); ?>" class="px-4 py-2 rounded-xl border border-slate-300 text-sm focus:ring-2 focus:ring-amber-500 outline-none w-full sm:w-64">
            <select name="category" class="px-4 py-2 rounded-xl border border-slate-300 text-sm focus:ring-2 focus:ring-amber-500 outline-none bg-white">
            ...
            <button type="submit" class="py-2 px-4 bg-slate-900 text-white font-semibold rounded-xl text-sm hover:bg-slate-800 transition-colors">Filter</button>
